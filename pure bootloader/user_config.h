...
/*Enable debug IO*/
#define EN_DEBUG_IO
#define TP_DebugPrintf Bootloader_DebugPrint
#define FLS_DebugPrintf Bootloader_DebugPrint
#define APP_DebugPrintf Bootloader_DebugPrint
#define UDS_DebugPrintf Bootloader_DebugPrint
...
#define fsl_memcpy memcpy
#define fsl_memset memset
